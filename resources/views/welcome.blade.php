...
<div id="container">
  <div class="container">
    <div class="row">               <div id="content" class="col-sm-12">            <div class="banner-1">
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="{{asset('two.jpg')}}" alt="banner-1"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>EyeLash</h2>
<h3>collection</h3></div></div>
            ...
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="phlashtools.com/image/cache/catalog/banners/banner2-464x560.png" alt="banner-2"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>VOLUME</h2>
<h3>collection</h3></div></div>
                                    </a>
            </div>
        </div>
            ...
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="phlashtools.com/image/cache/catalog/banners/banner3-696x560.png" alt="banner-3"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>EyeBrows</h2>
<h3>collection</h3></div></div>
                                    </a>
            </div>
        </div>
            ...
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="phlashtools.com/image/cache/catalog/banners/banner4-580x560.png" alt="banner-4"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>Tweezers</h2>
<h3>collection</h3></div></div>
                                    </a>
            </div>
        </div>
            ...
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="../phlashtools.com/image/cache/catalog/banners/banner5-580x560.png" alt="banner-4"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>Accessories</h2>
<h3>collection</h3></div></div>
                                    </a>
            </div>
        </div>
            ...
            <div class="banner-box">
                <a class="clearfix" href="">
                    <img src="{{asset('first.jpg')}}" alt="banner-4"
                         class="img-responsive"/>
                                            <div class="s-desc"><div class="vert-align"><h2>Tweezers</h2>
<h3>collection</h3></div></div>
                                    </a>
